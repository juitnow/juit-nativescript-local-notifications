...
export abstract class AbstractLocalNotifications extends LocalNotifications {
  private readonly _handers = new Set<LocalNotificationHandler>()
  protected readonly _handler: LocalNotificationHandler
